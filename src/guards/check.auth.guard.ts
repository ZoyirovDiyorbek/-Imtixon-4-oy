...
import { Protected, PROTECTED_KEY } from "src/decorators/protected.decorator";
...
export class CheckAuth implements CanActivate{
    ...
    canActivate(context: ExecutionContext): boolean | Promise<boolean> | Observable<boolean> {
        ...
        if(!token || !token.startsWith('Bearer')){
            throw new BadRequestException('Please enter token!')
        }
        ...
        try {
            ...
            throw new InternalServerErrorException('Interval error!')
        }
    }
